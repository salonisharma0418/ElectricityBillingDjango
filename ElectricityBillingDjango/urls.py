...
urlpatterns = [
    ...
    path('billData/', billDetialsPage,name='billData'),
    path('billData/<int:pid>', billDetialsPage,name='billData'),
    path('upload/', image_upload_view, name='upload'),
    path('contact/', contact,name='contact'),
    path('helpme/', helpme,name='helpme'),
    path('feedback/', submit_feedback, name='submit_feedback'), 
    path('reportIssues/', reportIssues,name='reportIssues'),
     path('teamandconditions/',teamandconditions,name='teamandconditions'),
]
if settings.DEBUG:
